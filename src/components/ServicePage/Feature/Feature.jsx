...
function Feature(props) {
    ...
    return (
        <>
            <section id="feature-section" className="bg-[#F5F5F5] mt-16">
                <div className="container pt-14">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {featuredServices.map((featureService, index) => (
                            <div key={index}
                                 className="mb-14 col hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex flex-col text-center items-center bg-white p-8">
